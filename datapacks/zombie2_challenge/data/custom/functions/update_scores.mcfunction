...
execute unless entity @a[tag=defender,scores={deaths=0}] unless entity @a[tag=builder,scores={deaths=0}] if score game_state game_score matches 0 run function custom:end_challenge
